...
function CheckoutMobile() {
  ...
  const renderSeats = () => {
    return danhSachGhe?.map((item, index) => {
      ...
      if (indexGheDD !== -1) {
        classGheDaDat = "gheDangDatMobile";
      }
      ...
      return (
        <Fragment key={index}>
          <button
            ...
            disabled={item.daDat}
            className={`gheMobile ${classGheVip}${classGheDangDat} ${classGheDaDat}   text-center`}
            key={index}
          >
            {item.daDat ? (
  ...
  return (
    ...
    >
      <div className="glassmorphism  w-screen">
        ...
        >
          <div className="glassmorphism flex justify-center  w-screen">
            <div className="text-white w-1/2  ">
              <h3 className="text-green-400 mt-10 text-center">
                Ticket Detail
              </h3>
              <hr />
              <h3
              ...
              <div style={{ marginBottom: 0 }}>
                <div
                  ...
                  className="bg-green-500 text-white cursor-pointer text-center py-3 font-bold text-2xl"
                >
                  ĐẶT VÉ
                </div>
              </div>
        ...
        <div key={index} className="p-2  w-full">
          ...
          >
            <img
              ...
              src={ticket.hinhAnh}
            />
            <div className="flex-grow text-left break-words break-all ... ">
