  ...
  useEffect(() => {
    https
      ...
      .then((res) => {
        ...
        dispatch(setHTR(res.data.content));
      })
      .catch((err) => {
        console.log("err: ", err);
      });
      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            ...
            >
              <div className="flex text-green-400 items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                <svg
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg text-green-400 font-medium text-center">
              Partner
            </p>
